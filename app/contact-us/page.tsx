    ...
    <>
      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <section className="relative h-[40vh] flex items-center">
          <div className="absolute inset-0 bg-[url('/images/contactimg1.png')] bg-cover bg-center before:content-[''] before:absolute before:inset-0 before:bg-black before:opacity-60" />
        ...
        {/* Background AA SVG */}
        <div className="absolute right-0 bottom-[-180px] z-0 opacity-80">
          <svg
            width="192"
            height="139"
            viewBox="0 0 192 139"
