...
const newsPosts: NewsPost[] = [
  {
    ...
    excerpt:
      "Discover how AI and automation are transforming project management practices and what it means for businesses.",
  ...
  },
  {
    ...
    excerpt:
      "Learn how agile methodologies are being adapted for different industries and business sizes.",
  ...
  },
  {
    ...
    excerpt:
      "Best practices for maintaining high quality standards with distributed teams.",
  ...
  },
  {
    ...
    excerpt:
      "Essential product management strategies for early-stage startups and scale-ups.",
  ...
  },
  {
    ...
    excerpt:
      "Strategies for assembling and managing teams that consistently deliver results.",
    category: "Project Management",
    date: "March 3, 2024",
    image: "/images/news-image.jpg",
    author: "James Wilson",
  ...
  },
  {
    ...
    excerpt:
      "New technologies and methodologies reshaping quality control processes.",
    category: "Quality Management",
    date: "March 1, 2024",
    image: "/images/news-image.jpg",
    author: "Rachel Kim",
  ...
  },
  {
    ...
    excerpt:
      "How to keep users at the center of your product development process.",
    category: "Product Management",
  ...
  },
  {
    ...
    excerpt:
      "Implementing environmentally conscious project management methodologies.",
    category: "Project Management",
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white relative overflow-hidden">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             ...
             {/* Background AA SVG */}
             <div className="absolute -right-5 -bottom-2/12">
              <svg
                width="192"
                height="139"
                viewBox="0 0 192 139"
