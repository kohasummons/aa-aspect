...
export function Hero() {
  ...
  return (
    <section ref={sectionRef} className="text-white h-[60vh] md:h-[111vh] relative">
      ...
      <div className="container mx-auto relative flex flex-col gap-20 md:gap-80 px-4 md:px-6">
        <motion.div
          ref={textRef1}
          style={{ y: y1, opacity }}
          className="text-4xl sm:text-5xl md:text-9xl mb-4 md:mb-8 pt-[150px] md:pt-[200px] font-candara-bold"
        >
          MAKING INNOVATION
          <br />
          COLLABORATIVE
        ...
        <motion.div
          ref={textRef2}
          style={{ y: y2, opacity }}
          className="text-3xl sm:text-4xl md:text-9xl text-right font-candara-bold"
        >
          DELIVERING
          <br />
          SOLUTIONS & GROWTH
