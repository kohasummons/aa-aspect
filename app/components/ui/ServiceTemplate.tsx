  ...
  return (
    <>
      ...
      <main className="">
        ...
        <section className="py-20 bg-white flex mx-auto justify-center items-center relative overflow-hidden">
          {/* Background AA SVG - Moved to top of section */}
          <div className="absolute -right-5 md:-bottom-5/12 -bottom-1/12 z-0">
              <svg
                width="192"
                height="139"
                viewBox="0 0 192 139"
          ...
          <>
            <section className="py-20 bg-white">
              <div className="container mx-auto px-4">
                ...
                >
                  <h2 className="text-3xl md:text-4xl font-candara-bold text-[#003840] mb-6">
                    {content.industries ? 'Industries We Serve' : 'Our Core Services'}
                  </h2>
                </motion.div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {(content.industries || content.coreServices)?.map((item, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
